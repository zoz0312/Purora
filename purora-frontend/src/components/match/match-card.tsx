...
const MatchCardComponent: React.FC<MatchCardProps> = (
  ...
  return (
    <div className={`max-w-4xl mx-auto bg-blue-50 flex flex-row text-gray-700 shadow-lg mb-5 w-full border border-white rounded-xl`}>
      ...
      <button
        className={`w-8 flex-grow-0 rounded-r-xl p-2 md:p-5 text-white text-2xl md:text-5xl bg-blue-300 hover:bg-blue-200 btn-normal focus:outline-none`}
